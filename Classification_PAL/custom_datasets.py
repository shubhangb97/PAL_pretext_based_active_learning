...
#still need to modify mean and variance
...
class Caltech256(Dataset):
    def __init__(self, path):
        self.caltech256 = datasets.Caltech256(root=path,download=True,
                                        transform=caltech256_transformer())
...
class Caltech101(Dataset):
    def __init__(self, path):
        self.caltech101 = datasets.Caltech101(root=path,download=True,
